...
/// <https://tailwindcss.com/docs/border-width>
pub static BORDER_WIDTH: TwPage = TwPage {
    slug: "border-width",
    title: "Border-width",
  ...
  border-bottom-width: <value>;
    ...
    examples: &[
        TwExample {
            ...
            snippet: r#"<div class="border border-indigo-600 ...">
</div>
...
<div class="border-8 border-indigo-600 ...">
            ...
            demo: el(
                ...
                &[
                    labeled("size-16 rounded-lg bg-white border border-indigo-600", ""),
                    labeled("size-16 rounded-lg bg-white border-2 border-indigo-600", ""),
                    labeled("size-16 rounded-lg bg-white border-4 border-indigo-600", ""),
                    labeled("size-16 rounded-lg bg-white border-8 border-indigo-600", ""),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<div class="border-t-4 border-indigo-500 ...">
</div>
...
<div class="border-l-4 border-indigo-500 ...">
            ...
            demo: el(
                ...
                &[
                    labeled(
                        "size-16 rounded-lg bg-white border-t-4 border-indigo-500",
                        "",
                    ),
                    labeled(
                        "size-16 rounded-lg bg-white border-r-4 border-indigo-500",
                        "",
                    ),
                    labeled(
                        "size-16 rounded-lg bg-white border-b-4 border-indigo-500",
                        "",
                    ),
                    labeled(
                        "size-16 rounded-lg bg-white border-l-4 border-indigo-500",
                        "",
                    ),
                ],
            ),
        ...
        TwExample {
            ...
            snippet: r#"<div class="border-x-4 border-indigo-500 ...">
</div>
<div class="border-y-4 border-indigo-500 ...">
</div>"#,
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[
                    labeled(
                        "size-16 rounded-lg bg-white border-x-4 border-indigo-500",
                        "",
                    ),
                    labeled(
                        "size-16 rounded-lg bg-white border-y-4 border-indigo-500",
                        "",
                    ),
                ],
            ),
            ...
            demo: el(
                ...
                &[
                    el(
                        "flex flex-wrap items-center gap-4",
                        &[labeled(
                            "size-16 rounded-lg bg-white border-s-4 border-indigo-500",
                            "",
                        )],
                    ),
                    labeled(
                        "text-xs text-slate-500",
                        "border-s-4 maps to the LTR side (left); border-bs-4 has no equivalent",
                    ),
                ],
            ),
        },
        TwExample {
            title: "Between children",
            prose: &[
            ...
            snippet: r#"<div class="grid grid-cols-3 divide-x-4">
<div>01</div>
<div>02</div>
<div>03</div>
</div>
...
<div>03</div>
            ...
            demo: el(
                ...
                &[
                    ...
                    labeled(
                        "text-xs text-slate-500",
                        "divide-y-reverse has no equivalent",
                    ),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<div class="border-[2vw] ...">
<!-- ... -->
</div>
            ...
            demo: el(
                ...
                &[
                    el(
                        "flex flex-wrap items-center gap-4",
                        &[labeled(
                            "size-16 rounded-lg bg-white border-[6px] border-indigo-500",
                            "",
                        )],
                    ),
                    labeled("text-xs text-slate-500", "border-[2vw] ≈ border-[6px]"),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<div class="border-2 md:border-t-4 ...">
<!-- ... -->
</div>"#,
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[labeled(
                    "size-16 rounded-lg bg-white border-2 md:border-t-4 border-indigo-500",
                    "",
                )],
            ),
        },
