...
/// <https://tailwindcss.com/docs/border-radius>
pub static BORDER_RADIUS: TwPage = TwPage {
    slug: "border-radius",
    title: "Border-radius",
...
border-bottom-left-radius: <value>;",
        ...
        ("rounded-s-*", "rounded-l-*"),
        ("rounded-e-*", "rounded-r-*"),
        ("rounded-ss-*", "rounded-tl-*"),
        ("rounded-se-*", "rounded-tr-*"),
        ("rounded-es-*", "rounded-bl-*"),
        ("rounded-ee-*", "rounded-br-*"),
    ],
    examples: &[
        TwExample {
            title: "Basic example",
            ...
            snippet: r#"<div class="rounded-sm ...">
</div>
...
<div class="rounded-xl ...">
            ...
            demo: el(
                ...
                &[
                    labeled("size-16 bg-sky-500 rounded-sm", ""),
                    labeled("size-16 bg-sky-500 rounded-md", ""),
                    labeled("size-16 bg-sky-500 rounded-lg", ""),
                    labeled("size-16 bg-sky-500 rounded-xl", ""),
                ],
            ),
        },
        TwExample {
            title: "Rounding sides separately",
            prose: &[
            ...
            snippet: r#"<div class="rounded-t-lg ...">
</div>
...
<div class="rounded-l-lg ...">
            ...
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[
                    labeled("size-16 bg-sky-500 rounded-t-lg", ""),
                    labeled("size-16 bg-sky-500 rounded-r-lg", ""),
                    labeled("size-16 bg-sky-500 rounded-b-lg", ""),
                    labeled("size-16 bg-sky-500 rounded-l-lg", ""),
                ],
            ),
        },
        TwExample {
            title: "Rounding corners separately",
            prose: &[
            ...
            snippet: r#"<div class="rounded-tl-lg ...">
</div>
...
<div class="rounded-bl-lg ...">
            ...
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[
                    labeled("size-16 bg-sky-500 rounded-tl-lg", ""),
                    labeled("size-16 bg-sky-500 rounded-tr-lg", ""),
                    labeled("size-16 bg-sky-500 rounded-br-lg", ""),
                    labeled("size-16 bg-sky-500 rounded-bl-lg", ""),
                ],
            ),
        },
        TwExample {
...
<div class="rounded-s-lg ...">
            ...
            demo: el(
                ...
                &[
                    el(
                        "flex flex-wrap items-center gap-4",
                        &[labeled("size-16 bg-sky-500 rounded-s-lg", "")],
                    ),
                    labeled(
                        "text-xs text-slate-500",
                        "rounded-s-lg maps to the LTR side (left)",
                    ),
                ],
            ),
        },
        TwExample {
            title: "Creating pill buttons",
            prose: &[
                "Use the rounded-full utility to create pill buttons:",
                "rounded-full",
            ],
            snippet: r#"<button class="rounded-full ...">Save Changes</button>"#,
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[labeled(
                    "rounded-md px-4 py-2 font-semibold text-white bg-sky-500 rounded-full",
                    "Save Changes",
                )],
            ),
        },
        TwExample {
            title: "Removing the border radius",
            prose: &[
                "Use the rounded-none utility to remove an existing border radius from an element:",
                "rounded-none",
            ],
            snippet: r#"<button class="rounded-none ...">Save Changes</button>"#,
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[labeled(
                    "rounded-md px-4 py-2 font-semibold text-white bg-sky-500 rounded-none",
                    "Save Changes",
                )],
            ),
        },
        TwExample {
            ...
            snippet: r#"<div class="rounded-[2vw] ...">
<!-- ... -->
</div>
...
<!-- ... -->
            ...
            demo: el(
                ...
                &[
                    el(
                        "flex flex-wrap items-center gap-4",
                        &[labeled("size-16 bg-sky-500 rounded-[12px]", "")],
                    ),
                    labeled("text-xs text-slate-500", "rounded-[2vw] ≈ rounded-[12px]"),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<div class="rounded md:rounded-lg ...">
<!-- ... -->
</div>"#,
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[labeled("size-16 bg-sky-500 rounded md:rounded-lg", "")],
            ),
        },
    ],
};
