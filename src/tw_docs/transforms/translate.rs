...
/// <https://tailwindcss.com/docs/translate>
pub static TRANSLATE: TwPage = TwPage {
    slug: "translate",
    title: "Translate",
    section: TwSection::Transforms,
    ...
    examples: &[
        TwExample {
            ...
            snippet: r#"<img class="-translate-6 ..." src="/img/mountains.jpg" />
...
<img class="translate-8 ..." src="/img/mountains.jpg" />"#,
            demo: el(
                ...
                &[
                    el(
                        ...
                        &[
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative -translate-6 size-24 rounded-lg object-cover",
                            ...
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-2 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-8 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                        ],
                    ...
                    labeled(
                        ...
                        "translate-* maps to relative insets in gpui (needs `relative`)",
                    ),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<img class="-translate-1/4 ..." src="/img/mountains.jpg" />
...
<img class="translate-1/2 ..." src="/img/mountains.jpg" />"#,
            demo: el(
                ...
                &[
                    el(
                        ...
                        &[
                            ...
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-4 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-12 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                        ],
                    ...
                    labeled(
                        "text-xs text-slate-500",
                        "-translate-1/4, translate-1/6, translate-1/2 (percentages) have no equivalent — spacing-scale values shown",
                    ),
                ],
            ),
        },
        TwExample {
            title: "Translating on the x-axis",
            prose: &[
            ...
            snippet: r#"<img class="-translate-x-4 ..." src="/img/mountains.jpg" />
                    ...
                    el(
                        ...
                        &[
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative -translate-x-4 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-x-2 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-x-12 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                        ],
                    ),
                    labeled("text-xs text-slate-500", "translate-x-1/2 ≈ translate-x-12"),
                ],
            ),
        },
        TwExample {
            title: "Translating on the y-axis",
            prose: &[
            ...
            snippet: r#"<img class="-translate-y-4 ..." src="/img/mountains.jpg" />
                    ...
                    el(
                        ...
                        &[
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative -translate-y-4 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-y-2 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                            el(
                                "size-24 rounded-lg bg-slate-200",
                                &[image(
                                    "relative translate-y-12 size-24 rounded-lg object-cover",
                                    "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                                )],
                            ),
                        ],
                    ),
                    labeled("text-xs text-slate-500", "translate-y-1/2 ≈ translate-y-12"),
                ],
            ),
        },
        TwExample {
            title: "Translating on the z-axis",
            prose: &[
            ...
            snippet: r#"<div class="transform-3d">
...
<img class="translate-z-1/2 rotate-x-50 rotate-z-45 ..." src="/img/mountains.jpg" />
            ...
            demo: el(
                ...
                &[
                    el(
                        "flex gap-10 p-6",
                        &[image(
                            "size-24 rounded-lg object-cover",
                            "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                        )],
                    ),
                    labeled(
                        "text-xs text-slate-500",
                        "translate-z-* / rotate-* / transform-3d have no equivalent",
                    ),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<img class="translate-[3.142rad] ..." src="/img/mountains.jpg" />
<img class="translate-(--my-translate) ..." src="/img/mountains.jpg" />"#,
            demo: el(
                ...
                &[
                    ...
                    labeled(
                        "text-xs text-slate-500",
                        "translate-[3.142rad] has no equivalent — translate-4 shown",
                    ),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<img class="translate-45 md:translate-60 ..." src="/img/mountains.jpg" />"#,
            demo: el(
                "flex gap-10 p-6",
                &[el(
                    "size-24 rounded-lg bg-slate-200",
                    &[image(
                        "relative translate-4 md:translate-8 size-24 rounded-lg object-cover",
                        "https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=640&h=360&fit=crop",
                    )],
                )],
            ),
