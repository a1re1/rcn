...
/// <https://tailwindcss.com/docs/width>
pub static WIDTH: TwPage = TwPage {
    slug: "width",
    title: "Width",
...
height: <value>;",
    ...
    examples: &[
        TwExample {
            ...
            snippet: r#"<div class="w-96 ...">w-96</div>
...
<div class="w-24 ...">w-24</div>"#,
            demo: el(
                ...
                &[
                    labeled(
                        "w-96 px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                        "w-96",
                    ),
                    labeled(
                        "w-80 px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                        "w-80",
                    ),
                    labeled(
                        "w-64 px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                        "w-64",
                    ),
                    labeled(
                        "w-48 px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                        "w-48",
                    ),
                    labeled(
                        "w-40 px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                        "w-40",
                    ),
                    labeled(
                        "w-32 px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                        "w-32",
                    ),
                    labeled(
                        "w-24 px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                        "w-24",
                    ),
                ],
            ),
...
<div class="w-full ...">w-full</div>"#,
            demo: el(
                ...
                &[
                    el(
                        ...
                        &[
                            labeled(
                                "w-1/2 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-1/2",
                            ),
                            labeled(
                                "w-1/2 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                    ...
                    el(
                        ...
                        &[
                            labeled(
                                "w-2/5 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-2/5",
                            ),
                            labeled(
                                "w-3/5 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-3/5",
                            ),
                        ],
                    ),
                    el(
                        ...
                        &[
                            labeled(
                                "w-1/3 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-1/3",
                            ),
                            labeled(
                                "w-2/3 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-2/3",
                            ),
                        ],
                    ),
                    el(
                        ...
                        &[
                            labeled(
                                "w-1/4 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-1/4",
                            ),
                            labeled(
                                "w-3/4 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-3/4",
                            ),
                        ],
                    ),
                    el(
                        ...
                        &[
                            labeled(
                                "w-1/5 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-1/5",
                            ),
                            labeled(
                                "w-4/5 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-4/5",
                            ),
                        ],
                    ),
                    el(
                        ...
                        &[
                            labeled(
                                "w-1/6 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-1/6",
                            ),
                            labeled(
                                "w-5/6 py-2 flex items-center justify-center rounded-lg text-white bg-indigo-500",
                                "w-5/6",
                            ),
                        ],
                    ),
        ...
        TwExample {
            ...
            snippet: r#"<div class="w-xl ...">w-xl</div>
...
<div class="w-3xs ...">w-3xs</div>"#,
            demo: el(
                ...
                &[
                    labeled(
                        "w-[36rem] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-purple-500",
                        "w-xl ≈ w-[36rem]",
                    ),
                    labeled(
                        "w-[32rem] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-purple-500",
                        "w-lg ≈ w-[32rem]",
                    ),
                    labeled(
                        "w-[28rem] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-purple-500",
                        "w-md ≈ w-[28rem]",
                    ),
                    labeled(
                        "w-[24rem] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-purple-500",
                        "w-sm ≈ w-[24rem]",
                    ),
                    labeled(
                        "w-[20rem] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-purple-500",
                        "w-xs ≈ w-[20rem]",
                    ),
                    labeled(
                        "w-[18rem] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-purple-500",
                        "w-2xs ≈ w-[18rem]",
                    ),
                    labeled(
                        "w-[16rem] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-purple-500",
                        "w-3xs ≈ w-[16rem]",
                    ),
                ],
            ),
        ...
        TwExample {
            ...
            snippet: r#"<div class="w-screen">
<!-- ... -->
</div>"#,
            demo: el(
                "w-full overflow-hidden rounded-lg",
                &[labeled(
                    "w-screen px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                    "w-screen",
                )],
            ),
        },
        TwExample {
            title: "Resetting the width",
            prose: &[
                "Use the w-auto utility to remove an element's assigned width under a specific condition, like at a particular breakpoint:",
            ],
            snippet: r#"<div class="w-full md:w-auto">
<!-- ... -->
</div>"#,
            demo: el(
                "w-96 rounded-lg bg-sky-300 p-2",
                &[labeled(
                    "w-full md:w-auto px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                    "w-full md:w-auto",
                )],
            ),
        },
...
<!-- ... -->
            ...
            demo: el(
                "flex flex-col items-start gap-2 ",
                &[labeled(
                    "w-[320px] px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                    "w-[320px]",
                )],
            ),
        },
        TwExample {
            ...
            snippet: r#"<div class="w-1/2 md:w-full ...">
<!-- ... -->
</div>"#,
            demo: el(
                "w-96 rounded-lg bg-sky-300 p-2",
                &[labeled(
                    "w-1/2 md:w-full px-4 py-2 flex items-center justify-center rounded-lg text-white bg-sky-500",
                    "w-1/2 md:w-full",
                )],
            ),
        },
