...
/// <https://tailwindcss.com/docs/font-size>
pub static FONT_SIZE: TwPage = TwPage {
    slug: "font-size",
    title: "Font-size",
...
line-height: var(--text-9xl--line-height); /* 1 */",
    ...
    examples: &[
        TwExample {
            ...
            snippet: r#"<p class="text-sm ...">The quick brown fox ...</p>
...
<p class="text-2xl ...">The quick brown fox ...</p>"#,
        ...
        TwExample {
            ...
            snippet: r#"<p class="text-sm/6 ...">So I started to walk into the water...</p>
...
<p class="text-sm/8 ...">So I started to walk into the water...</p>"#,
            demo: el(
                ...
                &[
                    labeled(
                        ...
                        "text-sm/6 ≈ text-sm leading-6 (size/line-height shorthand has no equivalent)",
                    ),
                    el(
                        "text-sm leading-6",
                        &[Node::Prose(
        ...
        TwExample {
            ...
            snippet: r#"<p class="text-[14px] ...">  Lorem ipsum dolor sit amet...</p>
<p class="text-(length:--my-text-size) ...">  Lorem ipsum dolor sit amet...</p>"#,
            demo: el(
                ...
                &[
                    labeled(
                        "text-xs text-slate-500",
                        "text-[14px] ≈ text-sm (arbitrary font sizes have no equivalent)",
                    ),
                    el(
                        "text-sm",
                        &[Node::Prose(
        ...
        TwExample {
            ...
            snippet: r#"<p class="text-sm md:text-base ...">  Lorem ipsum dolor sit amet...</p>"#,
            demo: el(
                "flex w-full flex-col gap-3",
                &[el(
