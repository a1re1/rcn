...
/// <https://tailwindcss.com/docs/color>
pub static COLOR: TwPage = TwPage {
    slug: "color",
    title: "Color",
    ...
    reference: &[
        ...
        (
            "text-zinc-50",
            "color: var(--color-zinc-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "text-zinc-100",
        ...
        (
            "text-neutral-50",
            "color: var(--color-neutral-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "text-neutral-100",
            "color: var(--color-neutral-100); /* oklch(97% 0 none) */",
        ),
        (
            "text-neutral-200",
            "color: var(--color-neutral-200); /* oklch(92.2% 0 none) */",
        ),
        (
            "text-neutral-300",
            "color: var(--color-neutral-300); /* oklch(87% 0 none) */",
        ),
        (
            "text-neutral-400",
            "color: var(--color-neutral-400); /* oklch(70.8% 0 none) */",
        ),
        (
            "text-neutral-500",
            "color: var(--color-neutral-500); /* oklch(55.6% 0 none) */",
        ),
        (
            "text-neutral-600",
            "color: var(--color-neutral-600); /* oklch(43.9% 0 none) */",
        ),
        (
            "text-neutral-700",
            "color: var(--color-neutral-700); /* oklch(37.1% 0 none) */",
        ),
        (
            "text-neutral-800",
            "color: var(--color-neutral-800); /* oklch(26.9% 0 none) */",
        ),
        (
            "text-neutral-900",
            "color: var(--color-neutral-900); /* oklch(20.5% 0 none) */",
        ),
        (
            "text-neutral-950",
            "color: var(--color-neutral-950); /* oklch(14.5% 0 none) */",
        ),
        (
            "text-stone-50",
        ...
        (
            "text-mauve-50",
            "color: var(--color-mauve-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "text-mauve-100",
    ...
    examples: &[
        TwExample {
            ...
            snippet: r#"<p class="text-blue-600 dark:text-sky-400">The quick brown fox...</p>"#,
            demo: el(
        ...
        TwExample {
            ...
            snippet: r#"<p class="text-blue-600/100 dark:text-sky-400/100">The quick brown fox...</p>
...
<p class="text-blue-600/25 dark:text-sky-400/25">The quick brown fox...</p>"#,
            demo: el(
                ...
                &[
                    ...
                    labeled(
                        ...
                        "/75 /50 /25 opacity modifiers have no equivalent — lighter shades shown instead",
                    ),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<p class="text-[#50d71e] ...">  Lorem ipsum dolor sit amet...</p>
<p class="text-(--my-color) ...">  Lorem ipsum dolor sit amet...</p>"#,
        ...
        TwExample {
            ...
            snippet: r#"<p class="...">  Oh I gotta get on that  <a class="underline hover:text-blue-600 dark:hover:text-blue-400" href="https://en.wikipedia.org/wiki/Internet">internet</a>,  I'm late on everything!</p>"#,
            demo: el(
                "flex flex-wrap gap-1",
                &[
                    Node::Prose("Oh I gotta get on that"),
                    el(
                        "underline hover:text-blue-600 dark:hover:text-blue-400",
                        &[Node::Prose("internet")],
                    ),
                    Node::Prose(", I'm late on everything!"),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<p class="text-blue-600 md:text-green-600 ...">  Lorem ipsum dolor sit amet...</p>"#,
            demo: el(
                "flex w-full flex-col gap-3",
                &[el(
                    "text-blue-600 md:text-green-600",
                    &[Node::Prose(
                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                    )],
                )],
