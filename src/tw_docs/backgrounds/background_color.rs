...
/// <https://tailwindcss.com/docs/background-color>
pub static BACKGROUND_COLOR: TwPage = TwPage {
    ...
    reference: &[
        ...
        (
            "bg-zinc-50",
            "background-color: var(--color-zinc-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "bg-zinc-100",
        ...
        (
            "bg-neutral-50",
            "background-color: var(--color-neutral-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "bg-neutral-100",
            "background-color: var(--color-neutral-100); /* oklch(97% 0 none) */",
        ),
        (
            "bg-neutral-200",
            "background-color: var(--color-neutral-200); /* oklch(92.2% 0 none) */",
        ),
        (
            "bg-neutral-300",
            "background-color: var(--color-neutral-300); /* oklch(87% 0 none) */",
        ),
        (
            "bg-neutral-400",
            "background-color: var(--color-neutral-400); /* oklch(70.8% 0 none) */",
        ),
        (
            "bg-neutral-500",
            "background-color: var(--color-neutral-500); /* oklch(55.6% 0 none) */",
        ),
        (
            "bg-neutral-600",
            "background-color: var(--color-neutral-600); /* oklch(43.9% 0 none) */",
        ),
        (
            "bg-neutral-700",
            "background-color: var(--color-neutral-700); /* oklch(37.1% 0 none) */",
        ),
        (
            "bg-neutral-800",
            "background-color: var(--color-neutral-800); /* oklch(26.9% 0 none) */",
        ),
        (
            "bg-neutral-900",
            "background-color: var(--color-neutral-900); /* oklch(20.5% 0 none) */",
        ),
        (
            "bg-neutral-950",
            "background-color: var(--color-neutral-950); /* oklch(14.5% 0 none) */",
        ),
        (
            "bg-stone-50",
        ...
        (
            "bg-mauve-50",
            "background-color: var(--color-mauve-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "bg-mauve-100",
    ...
    examples: &[
        TwExample {
            ...
            snippet: r#"<button class="bg-blue-500 ...">Button A</button>
...
<button class="bg-pink-500 ...">Button C</button>"#,
            demo: el(
                ...
                &[
                    labeled(
                        "rounded-md px-4 py-2 font-semibold text-white bg-blue-500",
                        "Button A",
                    ),
                    labeled(
                        "rounded-md px-4 py-2 font-semibold text-white bg-cyan-500",
                        "Button B",
                    ),
                    labeled(
                        "rounded-md px-4 py-2 font-semibold text-white bg-pink-500",
                        "Button C",
                    ),
                ],
            ),
        ...
        TwExample {
            ...
            snippet: r#"<button class="bg-sky-500/100 ...">
</button>
<button class="bg-sky-500/75 ...">
</button>
<button class="bg-sky-500/50 ...">
</button>"#,
            demo: el(
                "flex flex-col gap-3",
                &[
                    el(
                        "flex flex-wrap items-center gap-4",
                        &[
                            labeled("size-16 rounded-lg bg-sky-500", ""),
                            labeled("size-16 rounded-lg bg-sky-400", ""),
                            labeled("size-16 rounded-lg bg-sky-300", ""),
                        ],
                    ),
                    labeled(
                        "text-xs text-slate-500",
                        "bg-sky-500/75 and /50 opacity modifiers have no equivalent — lighter shades shown",
                    ),
                ],
            ),
        },
...
<!-- ... -->
            ...
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[labeled("h-16 w-48 rounded-lg bg-[#50d71e]", "bg-[#50d71e]")],
            ),
        },
        TwExample {
            ...
            snippet: r#"<button class="bg-indigo-500 hover:bg-fuchsia-500 ...">Save changes</button>"#,
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[labeled(
                    "rounded-md px-4 py-2 font-semibold text-white bg-indigo-500 hover:bg-fuchsia-500",
                    "Save changes",
                )],
            ),
        },
        TwExample {
            ...
            snippet: r#"<div class="bg-blue-500 md:bg-green-500 ...">
<!-- ... -->
</div>"#,
            demo: el(
                "flex flex-wrap items-center gap-4",
                &[labeled(
                    "h-16 w-48 rounded-lg bg-blue-500 md:bg-green-500 text-white flex items-center justify-center",
