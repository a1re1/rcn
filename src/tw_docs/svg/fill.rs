...
use gpui::{AnyElement, IntoElement as _, Styled as _, px};

use crate::theme::Theme;
use crate::tw::TwStyledExt as _;

/// An svg icon styled through the parser (`fill-*` sets the svg fill).
fn svg_demo(theme: &Theme, classes: &str) -> AnyElement {
    gpui::svg()
        .path(theme.icons.check())
        .size(px(48.))
        .tw_base(theme, classes)
        .into_any_element()
}

/// <https://tailwindcss.com/docs/fill>
pub static FILL: TwPage = TwPage {
    slug: "fill",
    title: "Fill",
    section: TwSection::Svg,
    ...
    reference: &[
        ...
        (
            "fill-zinc-50",
            "fill: var(--color-zinc-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "fill-zinc-100",
        ...
        (
            "fill-neutral-50",
            "fill: var(--color-neutral-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "fill-neutral-100",
            "fill: var(--color-neutral-100); /* oklch(97% 0 none) */",
        ),
        (
            "fill-neutral-200",
            "fill: var(--color-neutral-200); /* oklch(92.2% 0 none) */",
        ),
        (
            "fill-neutral-300",
            "fill: var(--color-neutral-300); /* oklch(87% 0 none) */",
        ),
        (
            "fill-neutral-400",
            "fill: var(--color-neutral-400); /* oklch(70.8% 0 none) */",
        ),
        (
            "fill-neutral-500",
            "fill: var(--color-neutral-500); /* oklch(55.6% 0 none) */",
        ),
        (
            "fill-neutral-600",
            "fill: var(--color-neutral-600); /* oklch(43.9% 0 none) */",
        ),
        (
            "fill-neutral-700",
            "fill: var(--color-neutral-700); /* oklch(37.1% 0 none) */",
        ),
        (
            "fill-neutral-800",
            "fill: var(--color-neutral-800); /* oklch(26.9% 0 none) */",
        ),
        (
            "fill-neutral-900",
            "fill: var(--color-neutral-900); /* oklch(20.5% 0 none) */",
        ),
        (
            "fill-neutral-950",
            "fill: var(--color-neutral-950); /* oklch(14.5% 0 none) */",
        ),
        (
            "fill-stone-50",
        ...
        (
            "fill-mauve-50",
            "fill: var(--color-mauve-50); /* oklch(98.5% 0 none) */",
        ),
        (
            "fill-mauve-100",
    ...
    examples: &[
        TwExample {
            ...
            snippet: r#"<svg class="fill-blue-500 ...">
<!-- ... -->
</svg>"#,
            demo: Node::Custom(|theme| svg_demo(theme, "fill-blue-500")),
        },
        TwExample {
            title: "Using the current color",
            prose: &[
            ...
            snippet: r#"<button class="bg-white text-indigo-600 hover:bg-indigo-600 hover:text-white ...">
<svg class="size-5 fill-current ...">
<!-- ... -->
</svg>  Check for updates</button>"#,
            demo: el(
                "flex flex-col gap-2",
                &[
                    el(
                        "flex items-center gap-2 rounded-md bg-white px-4 py-2 font-semibold text-indigo-600 border border-indigo-200 hover:bg-indigo-600 hover:text-white",
                        &[
                            Node::Custom(|theme| svg_demo(theme, "size-5 fill-indigo-600")),
                            Node::Prose("Check for updates"),
                        ],
                    ),
                    labeled(
                        "text-xs text-slate-500",
                        "fill-current has no equivalent — the icon is filled explicitly",
                    ),
                ],
            ),
        },
        TwExample {
            ...
            snippet: r#"<svg class="fill-[#243c5a] ...">
<!-- ... -->
</svg>
<svg class="fill-(--my-fill-color) ...">
<!-- ... -->
</svg>"#,
            demo: Node::Custom(|theme| svg_demo(theme, "fill-[#243c5a]")),
        },
        TwExample {
            ...
            snippet: r#"<svg class="fill-cyan-500 md:fill-cyan-700 ...">
<!-- ... -->
</svg>"#,
            demo: Node::Custom(|theme| svg_demo(theme, "fill-cyan-500 md:fill-cyan-700")),
        },
    ],
};
