...
//! Default Tailwind v4.1.12 color palette (theme.css --color-*).
...
pub(super) fn palette(name: &str) -> Option<Hsla> {
    Some(match name {
        ...
        "neutral-50" => oklch(0.985, 0.0, 0.0),
        "neutral-100" => oklch(0.97, 0.0, 0.0),
        "neutral-200" => oklch(0.922, 0.0, 0.0),
        "neutral-300" => oklch(0.87, 0.0, 0.0),
        "neutral-400" => oklch(0.708, 0.0, 0.0),
        "neutral-500" => oklch(0.556, 0.0, 0.0),
        "neutral-600" => oklch(0.439, 0.0, 0.0),
        "neutral-700" => oklch(0.371, 0.0, 0.0),
        "neutral-800" => oklch(0.269, 0.0, 0.0),
        "neutral-900" => oklch(0.205, 0.0, 0.0),
        "neutral-950" => oklch(0.145, 0.0, 0.0),
        ...
        "black" => Hsla::from(gpui::rgb(0x000000)),
        "white" => Hsla::from(gpui::rgb(0xffffff)),
        _ => return None,
    })
}
