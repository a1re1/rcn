...
|---|---|---|---|
| ☑ | [aspect-ratio](https://tailwindcss.com/docs/aspect-ratio) | 2 / 6 | #176 |
...
| ☑ | [display](https://tailwindcss.com/docs/display) | 6 / 23 | #176 |
...
| ☑ | [object-fit](https://tailwindcss.com/docs/object-fit) | 5 / 5 | #176 |
| — | [object-position](https://tailwindcss.com/docs/object-position) | 0 / 11 | |
| ☑ | [overflow](https://tailwindcss.com/docs/overflow) | 15 / 15 | #176 |
| — | [overscroll-behavior](https://tailwindcss.com/docs/overscroll-behavior) | 0 / 9 | |
| ☑ | [position](https://tailwindcss.com/docs/position) | 2 / 5 | #176 |
| ☑ | [top-right-bottom-left](https://tailwindcss.com/docs/top-right-bottom-left) | 70 / 121 | #176 |
| ☑ | [visibility](https://tailwindcss.com/docs/visibility) | 2 / 12 | #176 |
...
| | page | supported rows | PR |
|---|---|---|---|
| ☑ | [flex-basis](https://tailwindcss.com/docs/flex-basis) | 6 / 20 | #175 |
| ☑ | [flex-direction](https://tailwindcss.com/docs/flex-direction) | 4 / 4 | #175 |
| ☑ | [flex-wrap](https://tailwindcss.com/docs/flex-wrap) | 3 / 3 | #175 |
| ☑ | [flex](https://tailwindcss.com/docs/flex) | 4 / 7 | #175 |
| ☑ | [flex-grow](https://tailwindcss.com/docs/flex-grow) | 2 / 4 | #175 |
| ☑ | [flex-shrink](https://tailwindcss.com/docs/flex-shrink) | 2 / 4 | #175 |
| — | [order](https://tailwindcss.com/docs/order) | 0 / 6 | |
| ☑ | [grid-template-columns](https://tailwindcss.com/docs/grid-template-columns) | 1 / 5 | #175 |
| ☑ | [grid-column](https://tailwindcss.com/docs/grid-column) | 11 / 19 | #175 |
| ☑ | [grid-template-rows](https://tailwindcss.com/docs/grid-template-rows) | 1 / 5 | #175 |
| ☑ | [grid-row](https://tailwindcss.com/docs/grid-row) | 11 / 19 | #175 |
| ☑ | [grid-auto-flow](https://tailwindcss.com/docs/grid-auto-flow) | 5 / 5 | #175 |
| ☑ | [grid-auto-columns](https://tailwindcss.com/docs/grid-auto-columns) | 4 / 7 | #175 |
| ☑ | [grid-auto-rows](https://tailwindcss.com/docs/grid-auto-rows) | 4 / 7 | #175 |
| ☑ | [gap](https://tailwindcss.com/docs/gap) | 9 / 12 | #175 |
| ☑ | [justify-content](https://tailwindcss.com/docs/justify-content) | 7 / 11 | #175 |
| ☑ | [justify-items](https://tailwindcss.com/docs/justify-items) | 4 / 7 | #175 |
| ☑ | [justify-self](https://tailwindcss.com/docs/justify-self) | 4 / 7 | #175 |
| ☑ | [align-content](https://tailwindcss.com/docs/align-content) | 7 / 9 | #175 |
| ☑ | [align-items](https://tailwindcss.com/docs/align-items) | 5 / 8 | #175 |
| ☑ | [align-self](https://tailwindcss.com/docs/align-self) | 5 / 9 | #175 |
| ☑ | [place-content](https://tailwindcss.com/docs/place-content) | 7 / 10 | #175 |
| ☑ | [place-items](https://tailwindcss.com/docs/place-items) | 5 / 7 | #175 |
| ☑ | [place-self](https://tailwindcss.com/docs/place-self) | 4 / 7 | #175 |

## Spacing (2 in scope of 2)

| | page | supported rows | PR |
|---|---|---|---|
| ☑ | [padding](https://tailwindcss.com/docs/padding) | 27 / 44 | #173 |
| ☑ | [margin](https://tailwindcss.com/docs/margin) | 64 / 91 | #173 |

## Sizing (6 in scope of 12)

| | page | supported rows | PR |
|---|---|---|---|
| ☑ | [width](https://tailwindcss.com/docs/width) | 25 / 46 | #174 |
| ☑ | [min-width](https://tailwindcss.com/docs/min-width) | 13 / 30 | #174 |
| ☑ | [max-width](https://tailwindcss.com/docs/max-width) | 13 / 31 | #174 |
| ☑ | [height](https://tailwindcss.com/docs/height) | 25 / 34 | #174 |
| ☑ | [min-height](https://tailwindcss.com/docs/min-height) | 13 / 18 | #174 |
| ☑ | [max-height](https://tailwindcss.com/docs/max-height) | 13 / 18 | #174 |
...
| ☑ | [font-size](https://tailwindcss.com/docs/font-size) | 13 / 15 | #176 |
| — | [font-smoothing](https://tailwindcss.com/docs/font-smoothing) | 0 / 2 | |
| ☑ | [font-style](https://tailwindcss.com/docs/font-style) | 2 / 2 | #176 |
| ☑ | [font-weight](https://tailwindcss.com/docs/font-weight) | 9 / 11 | #176 |
| — | [font-stretch](https://tailwindcss.com/docs/font-stretch) | 0 / 12 | |
| ☑ | [font-variant-numeric](https://tailwindcss.com/docs/font-variant-numeric) | 8 / 9 | #176 |
...
| ☑ | [line-clamp](https://tailwindcss.com/docs/line-clamp) | 1 / 4 | #176 |
| ☑ | [line-height](https://tailwindcss.com/docs/line-height) | 3 / 7 | #176 |
...
| ☑ | [text-align](https://tailwindcss.com/docs/text-align) | 5 / 6 | #176 |
| ☑ | [color](https://tailwindcss.com/docs/color) | 245 / 293 | #176 |
| ☑ | [text-decoration-line](https://tailwindcss.com/docs/text-decoration-line) | 3 / 4 | #176 |
| ☑ | [text-decoration-color](https://tailwindcss.com/docs/text-decoration-color) | 246 / 293 | #176 |
| ☑ | [text-decoration-style](https://tailwindcss.com/docs/text-decoration-style) | 1 / 5 | #176 |
| ☑ | [text-decoration-thickness](https://tailwindcss.com/docs/text-decoration-thickness) | 2 / 5 | #176 |
...
| ☑ | [text-overflow](https://tailwindcss.com/docs/text-overflow) | 2 / 3 | #176 |
| ☑ | [text-wrap](https://tailwindcss.com/docs/text-wrap) | 2 / 4 | #176 |
...
| ☑ | [white-space](https://tailwindcss.com/docs/white-space) | 2 / 6 | #176 |
...
| ☑ | [background-color](https://tailwindcss.com/docs/background-color) | 245 / 293 | #176 |
| ☑ | [background-image](https://tailwindcss.com/docs/background-image) | 10 / 34 | #176 |
...
| | page | supported rows | PR |
|---|---|---|---|
| ☑ | [border-radius](https://tailwindcss.com/docs/border-radius) | 165 / 186 | #176 |
| ☑ | [border-width](https://tailwindcss.com/docs/border-width) | 31 / 54 | #176 |
| ☑ | [border-color](https://tailwindcss.com/docs/border-color) | 499 / 3516 | #176 |
| ☑ | [border-style](https://tailwindcss.com/docs/border-style) | 3 / 12 | #176 |
...
| | page | supported rows | PR |
|---|---|---|---|
| ☑ | [box-shadow](https://tailwindcss.com/docs/box-shadow) | 507 / 1189 | #176 |
| — | [text-shadow](https://tailwindcss.com/docs/text-shadow) | 0 / 300 | |
| ☑ | [opacity](https://tailwindcss.com/docs/opacity) | 1 / 3 | #176 |
...
| ☑ | [filter-grayscale](https://tailwindcss.com/docs/filter-grayscale) | 1 / 4 | #176 |
...
| | page | supported rows | PR |
|---|---|---|---|
| ☑ | [transition-property](https://tailwindcss.com/docs/transition-property) | 5 / 9 | #176 |
| — | [transition-behavior](https://tailwindcss.com/docs/transition-behavior) | 0 / 2 | |
| ☑ | [transition-duration](https://tailwindcss.com/docs/transition-duration) | 1 / 4 | #176 |
| ☑ | [transition-timing-function](https://tailwindcss.com/docs/transition-timing-function) | 4 / 7 | #176 |
| ☑ | [transition-delay](https://tailwindcss.com/docs/transition-delay) | 1 / 3 | #176 |
...
| ☑ | [translate](https://tailwindcss.com/docs/translate) | 15 / 37 | #176 |
...
| ☑ | [cursor](https://tailwindcss.com/docs/cursor) | 18 / 38 | #176 |
...
| | page | supported rows | PR |
|---|---|---|---|
| ☑ | [fill](https://tailwindcss.com/docs/fill) | 245 / 294 | #176 |
